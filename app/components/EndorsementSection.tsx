            ...
            <div className="container">
                <div className={styles.inner}>
                    <div className={styles.left}>
                        ...
                        <p className={styles.body}>Join hundreds of supporters across Kogi East's 9 LGAs — upload your photo, generate a personalised APC-branded flyer featuring you and Rt. Hon. (Dr.) Abdullahi Ibrahim Ali, and share it with your community on WhatsApp, Facebook, and Instagram.</p>
                        <div className={styles.steps}>
                            {[
                                { n: "1", text: <><strong>Upload or snap a selfie</strong> — use your phone camera or gallery image directly in your browser.</> },
                                { n: "2", text: <><strong>Choose from 6 stunning designs</strong> — bright, politically savvy templates featuring both you and Rt. Hon. (Dr.) Abdullahi Ibrahim Ali.</> },
