        ...
        <>
            <nav className={styles.nav} role="navigation" aria-label="Main navigation">
                <div className={styles.inner}>
                    <a href="/" className={styles.logo}>
                        <Image src="/images/apc-logo-1.png" alt="APC Logo" width={40} height={40} className={styles.logoImg} priority />
            ...
            <div className={`${styles.mobileNav} ${mobileOpen ? styles.mobileOpen : ""}`} role="dialog" aria-modal="true">
                ...
                <div className={styles.mobileLogo}>
                    <Image src="/images/apc-logo-1.png" alt="APC Logo" width={48} height={48} />
